...
export default function () {
    const requests = [
        {
            url: 'https://cycle.pickcar.online/api/v1/event/engine/on',
        ...
        {
            url: 'https://cycle.pickcar.online/api/v1/cycle',
            payload: JSON.stringify({
                vehicle_id: 1,
                cycle_cnt: 60,
        ...
        {
            url: 'https://cycle.pickcar.online/api/v1/event/engine/off',
            payload: JSON.stringify({
                vehicle_id: 1,
                mdn: "01234567890",
                status: false,
